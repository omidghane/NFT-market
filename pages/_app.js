                    ...
                    <div className="flex items-center">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-10 flex items-baseline">
                                ...
                                <Link href="/create_nft" className="ml-4 px-3 py-2 rounded-md text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700">Sell NFT</Link>
                                <DashboardButton />
                                <LoginButton />
                                <Link href="#" className="ml-2 px-3 py-2 rounded-md text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700"><ConnectWallet /></Link>
                            </div>
                        </div>
                    </div>
...
const DashboardButton = () => {
  ...
  return (
    <div>
      <Link href="/my-nfts" className="ml-4 px-3 py-2 rounded-md text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700">
        My NFTs
      </Link>
      {/* <Link href="/dashboard" className="ml-4 px-3 py-2 rounded-md text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700">
        Dashboard
      </Link> */}
    </div>
  );
...
const LoginButton = () => {
  ...
  return (
      <Link href="/register" className="ml-4 px-3 py-2 rounded-md text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700">
          Login/Register
      </Link>
  );
};
